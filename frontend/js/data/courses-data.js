const COURSES_DATA = {
    'Liderazgo Empático': {
        description: 'Desarrolla habilidades de liderazgo basadas en la empatía, la comunicación efectiva y la inteligencia emocional para guiar equipos de forma inspiradora.',
        icon: 'users',
        color: 'course-red',
        content: {
    ...
    'Comunicación Asertiva': {
        description: 'Domina el arte de expresar tus ideas con claridad, respeto y confianza. Aprende a comunicarte de forma efectiva en cualquier situación.',
        icon: 'message-circle',
        color: 'course-blue',
        content: {
            title: 'Contenido del Curso',
            sections: [
                {
                    ...
                    text: 'La comunicación asertiva es la capacidad de expresar pensamientos, sentimientos y necesidades de manera directa, honesta y respetuosa. Se diferencia de la pasividad (no expresar lo que se piensa) y de la agresividad (expresarlo sin respeto al otro). La asertividad es una habilidad que se puede aprender y practicar. Los cambios sociales, económicos y culturales de nuestra época exigen que desarrollemos estas competencias para enfrentar los desafíos del mundo actual.'
                },
                {
                ...
                },
                {
                    ...
                    text: 'La comunicación asertiva involucra tres canales simultáneos: el verbal (las palabras que elegimos), el paraverbal (el tono, ritmo y volumen de la voz) y el no verbal (lenguaje corporal, expresiones faciales). La coherencia entre estos tres canales es clave para ser percibido como asertivo. Un mensaje asertivo requiere alineación entre lo que decimos, cómo lo decimos y nuestro lenguaje corporal.'
                },
                {
    ...
    'Creatividad e Innovación': {
        description: 'Desbloquea tu potencial creativo para resolver problemas de forma innovadora. Aprende a pensar fuera de lo convencional.',
        icon: 'lightbulb',
        color: 'course-orange',
        content: {
            title: 'Contenido del Curso',
            sections: [
                ...
                },
                {
                    ...
                    text: 'Existen diversas herramientas que estructuran el proceso creativo: Design Thinking (empatizar, definir, idear, prototipar, testar), brainstorming, mapas mentales, la técnica SCAMPER (Sustituir, Combinar, Adaptar, Modificar, Poner en otros usos, Eliminar, Reorganizar) y el pensamiento lateral. Estas técnicas ayudan a generar ideas originales y útiles.'
                },
                {
    ...
    'Pensamiento Crítico': {
        description: 'Mejora tu capacidad de análisis, evaluación y toma de decisiones basada en evidencia y razonamiento lógico.',
        icon: 'brain',
        color: 'course-green',
        content: {
            title: 'Contenido del Curso',
            sections: [
                {
                    ...
                    text: 'Encarar los conflictos de manera creativa y propositiva o destructiva depende de cómo nos hayamos preparado. La comprensión tradicional se refleja en disposiciones directivas que atañen al arbitraje o juicio, dejando poco espacio al desarrollo de habilidades para negociar y resolver autogestivamente nuestras diferencias. El pensamiento crítico es esencial para abordar conflictos de forma constructiva.'
                },
                {
                    heading: 'Capacidades Personales e Interpersonales',
                    text: 'El desarrollo de capacidades personales, interpersonales e interinstitucionales permite la búsqueda y el logro de soluciones autogestionadas de los conflictos. Esto implica aprender a analizar situaciones, evaluar argumentos, identificar sesgos cognitivos y tomar decisiones fundamentadas. El pensamiento crítico es la base para una resolución efectiva de conflictos.'
                },
                {
                    heading: 'Identificación de Sesgos Cognitivos',
                    text: 'Los sesgos cognitivos son patrones sistemáticos de desviación del juicio racional. Entre los más comunes están el sesgo de confirmación (buscar información que confirme nuestras creencias), el efecto ancla (depender excesivamente de la primera información recibida) y la falacia del superviviente (generalizar basándose solo en casos exitosos). Identificarlos es esencial para pensar críticamente.'
                },
                {
                    heading: 'Técnicas de Análisis y Argumentación',
                    text: 'La argumentación lógica, el análisis DAFO (Debilidades, Amenazas, Fortalezas, Oportunidades), el pensamiento lateral y la resolución creativa de conflictos son herramientas fundamentales. Un argumento válido requiere premises verdaderas, razonamiento válido y evidencia que lo respalde. El análisis crítico permite evaluar la fortaleza de los argumentos y tomar decisiones informadas.'
                },
                {
    ...
    'Inteligencia Emocional': {
        description: 'Gestiona tus emociones para un mejor bienestar personal y profesional. Aprende a reconocer, comprender y regular tus emociones.',
        icon: 'heart',
        color: 'course-purple',
        content: {
            title: 'Contenido del Curso',
            sections: [
                {
                    ...
                    text: 'La gestión emocional hace referencia a la toma de conciencia de las propias emociones, a la aceptación de las mismas y a su correspondiente regulación. Las emociones son estados psicológicos complejos influidos por la experiencia personal, originados en respuesta a un acontecimiento interno o externo, y en los que interactúan tres componentes: experiencia subjetiva, respuesta fisiológica y respuesta conductual.'
                },
                {
                    heading: 'Autoconocimiento: Nuestro Universo Interno',
                    text: 'El autoconocimiento es la capacidad de dirigir la atención hacia uno mismo y tomar conciencia de diferentes aspectos de la identidad, así como de nuestras emociones, pensamientos y conductas. La educación socioemocional señala la importancia de que también aprendamos a descifrar nuestro mundo interno. Se basa en tres pilares: la identidad y las metas, el desarrollo de la atención y la conciencia de las emociones.'
                },
                {
                    heading: 'Componentes de la Inteligencia Emocional',
                    text: 'Según Daniel Goleman, la inteligencia emocional incluye: autoconocimiento (conocer nuestras propias emociones), autorregulación (manejar nuestras reacciones), motivación (impulso interno), empatía (comprender las emociones de los demás) y habilidades sociales (construir relaciones). Cada componente es fundamental para el bienestar personal y profesional.'
                },
                {
                    heading: 'Gestión Emocional en la Práctica',
                    text: 'Las emociones nos aportan información y nos impulsan a actuar. En función de cómo pensemos o interpretemos la realidad, así nos sentiremos y actuaremos. Las emociones están presentes desde que nacemos y juegan un papel clave en la construcción de nuestra personalidad. Gestionar nuestras emociones contribuye a mejorar nuestra autoestima y a relacionarnos con los demás de manera más saludable.'
                },
                {
                    heading: 'Emociones y Bienestar',
                    text: 'Lograr una adecuada gestión emocional contribuye a que seamos más felices. Las emociones cumplen una función informativa y motivadora. Cuando las emociones son intensas, es fundamental atender a nuestro autocuidado. La gestión emocional nos ayuda a mantener la calma, responder en lugar de reaccionar y construir relaciones más sanas y productivas.'
                }
            ]
        },
        resources: [
    ...
    'Trabajo en Equipo': {
        description: 'Colabora de manera efectiva para alcanzar objetivos comunes. Aprende a construir equipos cohesionados y productivos.',
        icon: 'user-plus',
        color: 'course-yellow',
        content: {
            title: 'Contenido del Curso',
            sections: [
                {
                    ...
                    text: 'La construcción colectiva es un proceso de enseñanza y aprendizaje donde los aprendices son sujetos activos que transforman y conservan la cultura mediante la interacción social. El enfoque sociocultural destaca el papel de la interacción social para el desarrollo cognoscitivo. Los intercambios estimulantes y activos entre maestro y alumno son fundamentales para aprender a pensar.'
                },
                {
                    heading: 'Aprendizaje Colaborativo',
                    text: 'Las actividades grupales constituyen uno de los medios más acertados para aprender a pensar sobre el pensamiento, y de esta forma tener alumnos independientes capaces de construir juicios. Para aprender se requiere del "hacer social", pero no cualquier acto social es igualmente estructurante y mediador. Los intercambios dentro del salón deben estimular el aprendizaje de contenidos y enseñar a pensar.'
                },
                {
                ...
                },
                {
                    ...
                    text: 'La comunicación es el pegamento del equipo. Sin comunicación efectiva, los equipos se fragmentan. Aprender a escuchar activamente, dar feedback constructivo y alinear expectativas es fundamental para la colaboración. Las reuniones efectivas, las herramientas de colaboración digital y la transparencia en la información fortalecen al equipo.'
                },
                {
                    heading: 'Construcción Colectiva en la Organización',
                    text: 'En el ámbito organizacional, la construcción colectiva implica crear conocimiento compartido a través de la interacción social. Las comunidades de práctica y aprendizaje permiten que los miembros compartan experiencias, resuelvan problemas juntos y generen soluciones innovadoras. El aprendizaje colaborativo supera al individual en complejidad y riqueza de perspectivas.'
                }
            ]
        },
        resources: [
    ...
    'Gestión del Tiempo': {
        description: 'Optimiza tu productividad y reduce el estrés laboral mediante técnicas efectivas de organización y planificación del tiempo.',
        icon: 'timer',
        color: 'course-cyan',
        content: {
            title: 'Contenido del Curso',
    ...
    'Resiliencia': {
        description: 'Fortalece tu capacidad para superar la adversidad, adaptarte a los cambios y crecer a partir de las dificultades.',
        icon: 'shield',
            ...
            sections: [
                {
                    ...
                    text: 'La frustración es una situación en la que una expectativa, un deseo, un proyecto o una ilusión no se cumple. Es la vivencia emocional ante una situación en la que un deseo no se satisface. Cuando esto ocurre, experimentamos enfado, tristeza, miedo o amedrentamiento. Es un evento interno en relación con una circunstancia externa. La frustración no es patológica en sí misma, pero debemos aprender a manejarla.'
                },
                {
                    heading: '¿Qué es la Tolerancia a la Frustración?',
                    text: 'Manejar la frustración es poner la energía para aceptar el evento interno manteniendo una posición valorizante de uno mismo y activa en relación con las circunstancias del entorno. Antes de poner energía en el Adulto (según el Análisis Transaccional), es necesario que el estado del yo Padre envíe mensajes que consientan al Niño aceptar la frustración. Esto permite que la angustia o la cólera no nos desborde.'
                },
                {
