import type { DiagnosticData } from "@/types/diagnostics";

export const DIAGNOSTICO_DATA: DiagnosticData = {
  ...
  sections: [
    {
      ...
      questions: [
        {
          question:
            "¿Con qué frecuencia identifica con precisión las emociones que está experimentando en un momento dado?",
          options: [
        ...
        {
          question:
            "¿Qué tan consciente es de sus fortalezas y limitaciones personales?",
          options: [
        ...
        {
          question:
            "Cuando recibe una retroalimentación negativa, ¿cómo reacciona típicamente?",
          options: [
        ...
        {
          question:
            "¿Qué tan consciente es del efecto que sus emociones tienen en las demás personas?",
          options: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "¿Qué hace cuando se enfrenta a una situación de alta presión o estrés?",
          options: [
        ...
        {
          question:
            "¿Cómo responde ante los cambios inesperados o los contratiempos?",
          options: [
        ...
        {
          question:
            "¿Qué tan bien tolera la frustración cuando no logra un objetivo?",
          options: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "¿Qué tan persistente es cuando enfrenta obstáculos en un proyecto?",
          options: [
    ...
    },
    {
      ...
      questions: [
        {
          question:
            "¿Qué tan bien comprende las emociones de las demás personas?",
          options: [
        ...
        {
          question:
            "¿Cómo reacciona cuando alguien cercano está pasando por un momento difícil?",
          options: [
        ...
        {
          question:
            "¿Qué tan bien tolera puntos de vista diferentes a los suyos?",
          options: [
        ...
        {
          question:
            "¿Cómo maneja las diferencias interpersonales en un equipo de trabajo?",
          options: [
    ...
    },
    {
      ...
      questions: [
        {
          question:
            "¿Qué tan bien identifica las emociones básicas (miedo, ira, tristeza, alegría, asco, sorpresa) en los demás?",
          options: [
        ...
        {
          question:
            "¿Qué tan bien se pone en el lugar del otro antes de reaccionar?",
          options: [
        ...
        {
          question:
            "¿Qué tan bien detecta las dinámicas emocionales en un grupo?",
          options: [
        ...
        {
          question:
            "¿Qué tan bien maneja las relaciones con personas de diferentes contextos culturales o sociales?",
          options: [
